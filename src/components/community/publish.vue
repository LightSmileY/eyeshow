    ...
    >
      <el-form :model="postData">
        ...
        <el-form-item label="话题" :label-width="formLabelWidth">
          <el-input type="textarea" autosize placeholder="帖子话题..." v-model="postData.post.title"></el-input>
        </el-form-item>
        ...
        <el-form-item label="图片" :label-width="formLabelWidth" v-if="postData.post.style == '1'">
          ...
          >
            <el-image width="100%" :src="dialogImageUrl" fit="contain"></el-image>
          </el-dialog>
        </el-form-item>
        <!-- ****************************上传视频********************** -->
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="toAddPost" size="mini">发表</el-button>
      </div>
    </el-dialog>
  </div>
</template>
